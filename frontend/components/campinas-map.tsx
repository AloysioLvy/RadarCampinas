...
export default function CampinasMap() {
  ...
  useEffect(() => {
    ...
    // dynamically importing Leaflet, a JavaScript map library
    const loadMap = async () => {
      const L = await import("leaflet");
      await import("leaflet/dist/leaflet.css");

      // removing some unwanted default icons from Leaflet
      ...
      // adding danger zones (example data)
      const dangerZones = [
